                ...
                <div className="p-3 border-t bg-white">
                  <div className="relative">
                    <textarea value={copilotInput} onChange={e => setCopilotInput(e.target.value)} onKeyDown={e => e.key === 'Enter' && (e.metaKey || e.ctrlKey) && handleCopilot()}
                      placeholder="Enter edit instruction..." rows={3} className="w-full p-3 pr-24 bg-gray-50 border border-gray-200 rounded-xl text-sm outline-none resize-none focus:ring-2 focus:ring-blue-500/20" />
                    <VoiceInputButton
